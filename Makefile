...
INTERFACE_SOURCES=domain/dish_domain.go domain/menu_domain.go domain/menu_with_dishes_domain.go domain/city_domain.go domain/allergen_domain.go infrastructure/db/sqlc/query.go 
