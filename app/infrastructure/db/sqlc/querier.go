...
type Querier interface {
	...
	ListAllergenByDishID(ctx context.Context, dishID string) ([]ListAllergenByDishIDRow, error)
	ListAllergenInDish(ctx context.Context, dishIds []string) ([]ListAllergenInDishRow, error)
